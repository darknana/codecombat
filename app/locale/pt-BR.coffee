module.exports = nativeDescription: "Português do Brasil", englishDescription: "Portuguese (Brazil)", translation:
  home:
    ...
    hoc_class_code: Eu tenho aula de Programação
    hoc_enter: Entre
    hoc_title: Hora de Programar?
...
#    campaign_old_multiplayer_description: "Relics of a more civilized age. No simulations are run for these older, hero-less multiplayer arenas."
  ...
  play_level:
    completed_level: Nível Finalizado
    course: Curso
    done: "Pronto"
  ...
  teachers:
    ...
    free_3: "O Conteúdo do CodeCombat é dividido em"
    free_4: "Cursos."
    free_5: "O Primeiro curso é grátis, e possui uma hora de conteúdo."
    free_6: "O acesso aos cursos adicionais pode ser desbloqueado comprando-os."
    teacher_subs_title: "Professores recebem assinaturas gratuitas!" # {change}
    teacher_subs_0: "Nós oferecemos período de teste grátis para professores."
    ...
    how_much_5: "Nós oferecemos descontos em compras a vista e pacotes anuais para grupos, como turmas ou escolas. Entre em contato."
  ...
  teachers_survey:
    ...
    being_reviewed_1: "Sua solicitação de assinatura de teste grátis está sendo" 
    being_reviewed_2: "revisada."
    approved_1: "Sua solicitação de assinatura de teste grátis foi" 
    approved_2: "aprovada."
    approved_3: "Mais intruções foram enviadas para"
    approved_4: "Inscreva seus alunos na"
    approved_5: "página"
    approved_6: "de cursos."
    denied_1: "Sua solicitação de assinatura de teste grátis foi" 
    denied_2: "negada."
    ...
    description_1b: "Você pode encontrar mais informações em nosso"
  ...
  contact:
    ...
    send: "Enviar opinião"
    contact_candidate: "Informar Candidato" # Deprecated
  ...
  account_settings:
    ...
    emails_tab: "Emails"
    admin: "Admin"
    manage_subscription: "Clique aqui para gerenciar sua assinatura"
  ...
  clans:
    ...
    view_attempt: "Clique para visualizar a tentativa."
  ...
  courses:
    ...
    invite_students: "Convidar alunoes para se juntarem a aula."
    invite_link_header: "Link para entrar no curso"
    invite_link_p_1: "Passe esse link para os estudantes que você gostaria que participasse do curso."
    invite_link_p_2: "Ou deixa que a gente envie os emails:"
    capacity_used: "Espaços usados do curso"
    enter_emails: "Adicione o endereço dos alunos que deseja convidar, um por linha"
    send_invites: "Enviar convites"
    title: "Título"
    description: "Descrição"
    creating_class: "Criando turma..."
    purchasing_course: "Comprando curso..."
    buy_course: "Comprar cursos"
    buy_course1: "Comprar esse curso"
    create_class: "Criar Turma"
    select_all_courses: "Selecione 'Todos os Cursos' para obter 50% de desconto!"
    all_courses: "Todos os Cursos"
    number_students: "Número de alunos"
    enter_number_students: "Adicione o número de alunos necessário para essa turma."
    name_class: "Nomeie sua turma"
    displayed_course_page: "Isso será mostrado para você e seus alunos na página do curso. Isso pode ser alterado depois."
    buy: "Comprar"
    purchasing_for: "Você está comprando uma licensa para"
    creating_for: "Você está criando uma turma para"
    for: "para"
    receive_code: "Depois disso você receberá um código de desbloqueio para distribuir para seus alunos, para que eles possam se inscrever na sua turma."
    free_trial: "Teste grátis para professores!"
    get_access: "para conseguir acesso individual para todos os cursos para avaliação."
    questions: "Dúvidas?"
    faq: "Cursos FAQ"
    question: "P:"
    question1: "Qual a diferença entre esses cursos e o modo de jogo para um jogador?"
    answer: "R:"
    answer1: "O modo do jogo foi desenvolvido para aprendizado individual, enquanto os cursos foram desenvolvidos para turmas."
    answer2: "O modo para um jogador possui itens, gemas, seleção de heróis, aumento de nível, e alguns adicionais. Cursos possuem ferramentas de gerenciamento de turmas e um aerodinâmico nível de estimulação focado no aluno."
    teachers_click: "Professores Cliquem Aqui"
    students_click: "Alunos Cliquem Aqui"
    courses_on_coco: "Cursos no CodeCombat"
    designed_to: "Os cursos foram desenvolvidos para introduzir os conceitos de ciência da computação usando o ambiente divertido e envolvente do CodeCombat.Os níveis do CodeCombat foram organizados através de tópicos chave para encorajar o aprendizado progressivo, através de um curso de 5 horas."
    more_in_less: "Aprenda mais em menos tempo"
    no_experience: "Não precisa ter experiência em programação"
    easy_monitor: "Fácil monitoramento de progresso dos alunos"
    purchase_for_class: "Compre um curso para toda sua turma. É muito fácil inscrever seus alunos!"
    see_the: "Veja o"
    more_info: "para mais informações."
    choose_course: "Escolhar Seu Curso:"
    enter_code: "Adicione o código de desbloqueio e entre em uma classe já existente."
    enter_code1: "Adicionar código de desbloqueio"
    enroll: "Inscrever"
    pick_from_classes: "Escolha uma de suas turmas atuais."
    enter: "Entre"
    or: "Ou"
    topics: "Tópicos"
  ...
  ladder:
    ...
    simulation_explanation_leagues: "Você ira ajudar a simular jogos para jogadores aliados em seus clan e cursos."
    ...
    games_in_queue: "Jogos que já estão na fila:"
    ...
    defeat_the: "Derrote"
    watch_battle: "Assistir à batalha"
    ...
    tournament_blurb_zero_sum: "Libere sua criatividade de programação no recolhimento do ouro e nas táticas de batalhas nessa batalha invertida entre magos vermelhos e azuis. O torneio começa na sexta, no dia 27 de março e vai durar até segunda, dia 6 de abril. Compita pela diversão e pela glória! Confira os detalhes"
    tournament_blurb_ace_of_coders: "Batalhe no gelo glacial nessa disputa invertida de dominação! O torneio começa na quarta, 16 de setembro e vai durar até quarta, 14 de outubro. Confira os detalhes"
  ...
  account_prepaid:
    purchase_code: "Compre um código de assinatura"
    purchase_code1: "Códigos de assinatura pode ser resgatados para adicionar assinaturas premium para uma ou mais contas no CodeCombat."
    purchase_code2: "Cada conta no CodeCombat pode resgatar apenas um código de assinatura por vez."
    purchase_code3: "Códigos de assinatura mensais podem ser adicionados no final de qualquer assinatura da sua conta."
    users: "Usuários"
    months: "Meses"
    purchase_total: "Total"
    purchase_button: "Finalizar Compra"
    your_codes: "Seus códigos"
    redeem_codes: "Resgatar código de assinatura"
    prepaid_code: "Código Pré-pago"
    lookup_code: "Procurar cógido Pré-pago"
    apply_account: "Adicionar a sua conta"
    copy_link: "Você pode copiar o link do código e enviar para alguém."
    quantity: "Quantidade"
    redeemed: "Resgatada"
    no_codes: "Ainda sem códigos!"
    you_can1: "Você pode"
    you_can2: "adquirir códigos pré-pagos"
    you_can3: "que podem ser adicionados a sua conta ou dar para outras pessoas."
  ...
  resources:
    ...
    campaigns: "Campanhas"
    poll: "Questionário"
    user_polls_record: "Histórico de Votação"
