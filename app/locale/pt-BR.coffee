...
#    campaign_old_multiplayer_description: "Relics of a more civilized age. No simulations are run for these older, hero-less multiplayer arenas."
  ...
  teachers:
    ...
    private_clans_1:"Clans Privados  "Private Clans proporcionam maior privacidade e informação detalhada do progresso de cada estudante."
    private_clans_2: "Para criar um Clan Privado, marque o espaço 'Criar um Clan Privado', quando estiver criando um"
    private_clans_3: "."
    ...
    who_for_2: "Nós projetamos o CodeCombat para tanto para meninos como para meninas" "We've designed CodeCombat to appeal to both boys and girls."
    material_title: "Quanto material ele possui?"
    material_china: "Até o momento são aproximadamente 40 horas de tempo de jogo, distribuidos em mais de 170+ níveis exclusivos para assinantes."
    material_1: "Aproximadamente 25 horas de conteúdo gratuíto e um adicional de 15 horas"Approximately 25 de conteúdo para assinantes."
    concepts_title: "Quais conceitos são abordados?"
    how_much_title: "Quanto custa a assinatura mensal?"
    how_much_1: "Uma"
    how_much_2: "inscrição mensal"
#   how_much_3: "costs $9.99, and can be cancelled anytime."
    how_much_4: "Adicionalmente, nós oferecemos descontos para grupos grandes:"
#    how_much_5: "Aceitamos dar descontos em compras únicas e compras de assinaturas anuais para grupos, como uma classe ou escola. Por favor entre em contato"
