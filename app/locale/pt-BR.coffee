module.exports = nativeDescription: "Português do Brasil", englishDescription: "Portuguese (Brazil)", translation:
  ...
  play:
    ...
    campaign_old_multiplayer: "(Obsoleto) Antigas Arenas de Multijogadores"
    campaign_old_multiplayer_description: "Relíquias de uma era mais civilizada. Não há simulações sendo realizadas para para essas eras, essa arena multiplayer não possui heróis."

  share_progress_modal:
    blurb: "Você está fazendo progredindo bastante! Compartilhe com alguém o quanto você já aprendeu com o CodeCombat!"
  ...
  play_level:
    ...
    tip_solve_then_write: "Primeiro, solucione o problema. Depois escreva o código - John Johnson"
  ...
  leaderboard:
    view_other_solutions: "Confira Outras Soluções" # {change}
    scores: "Pontuação"
  ...
  subscribe:
    ...
    free: "Grátis"
    month: "mês"
    must_be_logged: "Você precisa estar logado. Por favor, crie uma conta ou faça o login no menu acima."
    ...
    sale_view_button: "Compre um ano de assinatura por"
  ...
  about:
    ...
    rob_blurb: "Codifica coisas"
    josh_c_title: "Designer do Jogo"
    josh_c_blurb: "Projeta Jogos"
    carlos_title: "Gerente Regional, Brasil"
    carlos_blurb: "Homem-Aipo"
  ...
  teachers:
    ...
    cost_premium_server: "O CodeCombat disposibiliza de graça as 5 primeiras fases, depois disso será cobrado o valor de $9.99 USD por mês para ter acesso as nossas mais de 190 fases disponibilizadas em nossos servidores."
    ...
    teacher_subs_0: "Nós oferecemos assinaturas grátis para professores para fins de avaliação."
    teacher_subs_1: "Por favor entre em contato" 
    ...
    how_much_5: "Nós damos descontos em compras a vista e assinaturas anuais para grupos, assim como para escolas ou faculdades. Entre em contato"
  ...
  account_settings:
    ...
    reset_your_progress: "Apague todo o seu progresso e comece de novo"
    god_mode: "Modo Deus"
    password_tab: "Senha"
    emails_tab: "Emails"
    admin: "Admin"
    ...
    type_in_email_progress: "Digite seu email e confirme a limpeza do progresso."
  ...
  clans:
    ...
    track_concepts1: "Conceitos de Trilha"
    track_concepts2a: "Aprendido por todos os alunos"
    track_concepts2b: "Aprendido por todos os membros"
    track_concepts3a: "As fases da Trilha foram concluídas por todos os alunos."
    track_concepts3b: "As fases da Trilha foram completadas por todos os membros"
    track_concepts4a: "Veja seus alunos"
    track_concepts4b: "Veja seus membros"
    track_concepts5: "Soluções"
    track_concepts6a: "Organizar alunos por nome ou progresso"
    track_concepts6b: "Organizar membros por nome ou progresso"
    track_concepts7: "Requer Convite"
    track_concepts8: "Para Participar"
    private_require_sub: "É preciso uma assinatura do site para criar ou se juntar a clans privados."

    Cursos:
    course: "Curso"
    courses: "Cursos"
    not_enrolled: "Você não está matriculado nesse curso."
    visit_pref: "Por favor, visite a"
    visit_suf: "Página para se matricular."
    select_class: "Selecione uma das suas aulas"
    unnamed: "*Sem nome*"
    select: "Selecionar"
    unnamed_class: "Aula não nomeada"
    edit_settings: "Editar configurações de aula"
    edit_settings1: "Editar configuração de aula"
    progress: "Progresso da Aula"
    add_students: "Adicionar Alunos"
    stats: "Estatísticas"
    total_students: "Total de estudantes:"
    average_time: "Tempo médio de jogo:"
    total_time: "Tempo total de jogo:"
    average_levels: "Média de fases concluídas:"
    total_levels: "Total de fases concluídas:"
    furthest_level: "Última fase concluídas:"
    concepts_covered: "Conceitos abrangidos"
    students: "alunos"
    students1: "alunos"
    ...
    invite_students: "Convidar alunos para se juntar a aula."
    invite_link_header: "Link para se juntar ao cursoe"
    invite_link_p_1: "Dê esse link para os alunos que você gostaria que se juntassem ao curso."
    invite_link_p_2: "Ou a gente pode enviar um email para eles:"
    capacity_used: "Slots usados no curso:"
    enter_emails: "Adicione, um email por linha, dos alunos para convidá-los"
    send_invites: "Enviar Convites"
    title: "Título"
    description: "Descrição"
    creating_class: "Criando aula."
    purchasing_course: "Comprando curso..."
    buy_course: "Comprar Cursos"
    buy_course1: "Comprar este cursos"
    create_class: "Criar Aula"
    select_all_courses: "Selecione 'Todos os Cursos', para um desconto de 50%!"
    all_courses: "Todos os Cursos"
    number_students: "Número de alunos"
    enter_number_students: "Adicione o número de alunos que você precisa para essa aula"
    name_class: "Nomeei a sua Aula"
    displayed_course_page: "Isso irá aparecer na página do curso para você e seus alunos. Pode ser alterado depois."
    buy: "Comprar"
    purchasing_for: "Você está comprando uma licença para"
    creating_for: "Você está criando uma sala para"
...
#    more_info: "for more information."
    choose_course: "Escolha o seu cursos:"
...
#    hours_content: "Hours of content:"
    get_free: "Ganhe um curso GRÁTIS"
...
#    you_can3: "that can be applied to your own account or given to others."
  ...
  resources:
    ...
    campaigns: "Campanhas"
    poll: "Enquete"
    user_polls_record: "Histórico de votações"
